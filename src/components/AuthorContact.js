...
function AuthorContact({ authorContactToggler }) {
	...
	return (
		<section
			className="coder-info bg-gray-800 text-gray-200 text-font-bold absolute top-0 right-0 bottom-0 left-0 z-10 pt-10"
		...
		>
			{/* CONTACT CONTENT */}
			<div className="contact-content bg-gray-900 shadow rounded-2xl w-3/4 h-5/6 md:w-3/5 mx-auto my-0 flex flex-col items-center justify-evenly relative">
				<div
