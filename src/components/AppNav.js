...
function AppNav() {
	...
	return (
		<nav className="app-nav shadow-inner md:shadow text-font-bold capitalize bg-gray-800 flex items-center content-between fixed left-0 right-0 h-12 bottom-0 md:top-0 2xl:h-14">
